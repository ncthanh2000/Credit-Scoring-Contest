...
clf_feature_selection = LGBMClassifier(boosting_type='gbdt', class_weight='balanced',
               ...
               min_split_gain=0.01, n_estimators=200, n_jobs=-1, num_leaves=31,
               objective='binary', random_state=42, reg_alpha=0.5, reg_lambda=0,
...
plt.savefig(r'Result/'+clf.__class__.__name__+'.png')
plt.show()
